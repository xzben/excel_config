...
def exportclient():
  export(EXPORT_FILES + EXPORT_CLIENT_ONLY, 'json', 'client', 'config_client', 'Config', 'schemaserver.json')

    
def exportserver():
  export(EXPORT_FILES + EXPORT_SERVER_ONLY, 'lua', 'server', 'config_server', '', None)
